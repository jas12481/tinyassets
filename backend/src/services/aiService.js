...
async function openAIAssistant(question, context, conversationHistory = []) {
  ...
  try {
    // Dynamic import for OpenAI (optional dependency)
...
- Earned badges: ${JSON.stringify(earnedBadges?.slice(0, 3) || [])}

Provide helpful, educational responses focused on the child's learning journey. Be encouraging and explain concepts in parent-friendly language.`;
